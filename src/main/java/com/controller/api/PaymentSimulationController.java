...
public class PaymentSimulationController {
    ...
    public String simulateQrScan(
        ...
        if (user != null) {
            ...
            // Tự động lấy Base URL (ví dụ: http://localhost:8080/spring_mvc hoặc link
            // ngrok)
            ...
            model.addAttribute("message", "Quét mã thành công! Một email xác nhận đã được gửi đến " + user.getEmail()
